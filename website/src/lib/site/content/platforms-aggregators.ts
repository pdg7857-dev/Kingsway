    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "h3", text: "Why commodity-code matching breaks down" },
          { type: "p", text: "It is worth being concrete about why code matching fails so often, because it is the same failure across every code-driven platform and it is not anybody's fault. A buyer setting up a solicitation picks commodity codes the way a busy person picks anything from a long list: they choose something close enough, not something perfect. A facilities project that touches mechanical, electrical and general work gets tagged with one code, or with a broad parent code, when it really spans three. Your profile, meanwhile, is built around the codes that describe your trade precisely. When the buyer's loose choice and your precise registration do not overlap, the match never happens, and neither the free plan nor the Pro recommendation engine can rescue a match that the coding never made possible. The work is sitting on a portal you can reach. The system simply never connected it to you." },
        ],
      },
      {
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "p", text: "It also helps to be honest about why fragmentation persists. Each agency adopts the sourcing tool that suits its own procurement office, on its own timeline, for its own reasons. No one is coordinating toward a single national or even regional feed, and there is no incentive for them to. Bonfire's growth within the Euna ecosystem is a sign of that pattern continuing, not reversing: more buyers, more portals, more separate front doors. For a contractor that means the coverage problem does not get easier over time. It gets harder, quietly, as more of your buyers move onto systems you then have to find and join." },
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "p", text: "A word on the division of labour, because it matters. I find and qualify the work. I do not write your proposal or submit it for you, and I would not want to, because the response is your craft and your relationship with the buyer. What I do is make sure that by the time a proposal decision lands on your desk, it is the right decision to be making: a real fit, on a real portal, with the documents read and the catches flagged. That is the part Bonfire cannot do and the part that, done well, changes how your whole pursuit pipeline runs." },
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "h3", text: "Why the sector concentration cuts both ways" },
          { type: "p", text: "The sector concentration is what makes Biddingo valuable, and it is also what makes it easy to under-serve. A contractor who lives in education and housing should treat Biddingo as a primary channel, because so much of that work flows through it. But the same concentration means a contractor who works municipalities broadly might assume Biddingo is a minor platform and barely watch it, only to find that a specific school board or housing provider in their area distributes there and almost nowhere else they look. The platform does not announce which of your buyers it carries. You discover that buyer by buyer, and the cost of guessing wrong is a contract you never saw open." },
        ],
      },
      {
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "p", text: "There is a competitive dimension here that is easy to underrate. In sectors as specialized as education and housing, the contractors who win are often the ones who simply saw the work first and prepared while everyone else was reacting. When a platform is sector-specific and its footprint is opaque, the firms that put in the work to know exactly which buyers distribute through it gain an information edge that compounds. Every cycle they are ready, and every cycle the firms relying on category alerts alone find out late. Over a few years that gap in who-saw-it-first turns into a real gap in who holds the contracts." },
        ],
      },
      {
        id: "how-i-help",
        ...
        blocks: [
          ...
          { type: "p", text: "I want to be clear about where my work ends, because it keeps the relationship honest. I find and qualify the opportunities. I do not write or submit your proposals. In education and housing especially, the proposal is where your past performance, your references and your understanding of the buyer do the winning, and that is your work to own. My job is to make sure you are spending that effort on the right competitions: genuine fits, surfaced in time, with the sector language decoded and the documents read. Get the front of the pipeline right and the back of it, the writing and pricing your team already does well, finally gets pointed at the work worth winning." },
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "h3", text: "Why per-instance registration quietly fails you" },
          { type: "p", text: "The per-instance model has a failure mode that is easy to miss because it feels like success. You register with a municipality, you select your categories, you start getting notifications, and everything seems to be working. What you cannot see is the municipality next door that you never joined, or the category on this instance that you set up slightly differently than you did on another, or the profile field that went stale when your bonding capacity or service area changed. Each instance is a small contract between you and that buyer about what you want to hear, and contracts drift. Multiply a small amount of drift across a dozen instances and you have a coverage map full of holes you have no way of seeing from inside any single portal." },
        ],
      },
      {
        id: "alert-limitations",
        ...
        blocks: [
          ...
          { type: "stat", id: "response-hours" },
          { type: "p", text: "The addendum problem deserves emphasis because it is the one that quietly loses bids that were otherwise going well. On municipal work, addenda are routine: a clarification here, a revised drawing there, a moved closing date when questions pile up. Each one can change what you are pricing or when you have to submit. The notification you got was about the original notice, and unless your profile is current and the instance reaches you again, the change can slip past while you keep working to a spec that is no longer the spec. A bid built on an out-of-date scope is not a near miss. It is a disqualification or a loss you never saw coming." },
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "p", text: "The access friction is what makes bids&tenders distinct from the other fragmented platforms, and it deserves its own moment. On most per-portal systems the cost of looking is just your time. On bids&tenders the cost can include logging in before you see anything, registering before you can even ask a question, and paying a document fee before you can read the full scope. Each of those is small on its own. Stacked across dozens of municipal instances, they add up to a real toll on a contractor's day, and the natural response, skipping the look, is exactly how winnable work goes unbid. The friction does not just slow you down. It quietly shapes which opportunities you bother to evaluate at all, and that is a worse outcome than a missed notification." },
        ],
      },
      {
        id: "how-i-help",
        ...
        blocks: [
          ...
          { type: "p", text: "It is worth saying plainly what I do not do, because it defines the handoff. I find and qualify the work; I do not write or submit your bid. The submission, the pricing, the schedule and the relationship with the municipality are yours, and they should be. What I take off your plate is everything in front of that: finding the instances, absorbing the access friction, reading the solicitations and addenda, and deciding what genuinely fits before it reaches your estimators. The cleaner that front end is, the more of your team's time goes to the part only your team can do, which is winning the work." },
