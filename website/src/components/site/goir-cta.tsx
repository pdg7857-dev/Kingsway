...
import { REPORT_URL } from "@/lib/site/config";

// When the report app URL is external (the separate goir/ deployment), open it
// in a new tab; otherwise it's the internal marketing landing page.
      ...
      <div className="container py-16 sm:py-20">
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-bg-panel to-bg px-6 py-12 sm:px-12">
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              <p className="eyebrow text-accent">Free assessment</p>
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <Link href={REPORT_URL} {...reportLinkProps} className="btn-gold px-6 py-3 text-base">
